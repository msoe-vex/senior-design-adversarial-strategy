...
from entities.scoring_elements import GoalLevel, HighNeutralGoal, LowNeutralGoal, RedGoal, BlueGoal, Ring, RingContainer
...
def starting_representation():
    ...
    return FieldRepresentation(rings=ring_arr, goals=goal_arr, red_platform=red_plat, blue_platform=blue_plat, robots=robot_arr)
